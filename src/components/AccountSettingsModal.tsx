        ...
        <div className="p-5 overflow-y-auto flex-1 space-y-4">
          ...
          {activeTab === 'data_export' && (
            <div className="space-y-4">
              ...
              <div className="p-3.5 bg-[var(--surface-secondary)] rounded-lg border border-[var(--border-primary)] space-y-2">
                <h4 className="text-xs font-bold text-[var(--text-primary)]">Legal Documents &amp; Regulatory Disclosures</h4>
                <p className="text-[11px] text-[var(--text-secondary)]">
                  Review the current canonical version (v1.0) of our legal agreements, privacy policies, and non-advisory disclaimers.
                </p>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1">
                  <button
                    type="button"
                    onClick={() => setLegalModalTab('terms')}
                    className="p-2 bg-[var(--surface-primary)] hover:bg-[var(--surface-hover)] border border-[var(--border-primary)] rounded-lg text-[11px] font-semibold text-[var(--text-primary)] flex items-center justify-center gap-1.5 transition"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setLegalModalTab('billing')}
                    className="p-2 bg-[var(--surface-primary)] hover:bg-[var(--surface-hover)] border border-[var(--border-primary)] rounded-lg text-[11px] font-semibold text-[var(--text-primary)] flex items-center justify-center gap-1.5 transition"
                  >
                    <CreditCard className="w-3.5 h-3.5 text-[var(--accent-gold)]" />
                  ...
                  <button
                    ...
                    className="p-2 bg-[var(--surface-primary)] hover:bg-[var(--surface-hover)] border border-[var(--border-primary)] rounded-lg text-[11px] font-semibold text-[var(--text-primary)] flex items-center justify-center gap-1.5 transition"
                  >
                    <AlertTriangle className="w-3.5 h-3.5 text-[var(--accent-gold)]" />
