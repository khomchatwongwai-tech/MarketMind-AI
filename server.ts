...
import { MassiveWebSocketManager } from './src/services/massiveWsManager.js';
import { RealtimeServerManager } from './src/server/realtimeServerManager.js';
import {
...
import { InstitutionalCopilotService, getGeminiModel } from './src/services/ai/institutionalCopilotService.js';
import { ServerUserStore } from './src/services/serverUserStore.js';
import { SUBSCRIPTION_PLANS, TRIAL_DURATION_DAYS } from './src/config/plans.js';
import { SubscriptionPlanId } from './src/types/subscription.js';
import { newsIntelligenceService } from './src/services/newsIntelligenceService.js';
import { InstrumentDirectoryService, MASTER_INSTRUMENTS } from './src/services/marketProviders/InstrumentDirectoryService.js';
import { DataProviderRouter } from './src/services/marketProviders/DataProviderRouter.js';
import { executeMultiAssetAIAnalysis } from './src/services/geminiMultiAssetService.js';
import { UniversalAssetClass } from './src/types/instrument.js';
import { requireAuth, requireRole, requireAnyRole, requireEntitlement, AuthenticatedRequest } from './src/server/authMiddleware.js';
import { StripeService } from './src/server/stripeService.js';
import { DeepResearchEngine } from './src/services/deepResearch/deepResearchEngine.js';
import { SecEdgarService } from './src/services/deepResearch/secEdgarService.js';
import { MacroDataService } from './src/services/deepResearch/macroDataService.js';
import { ResearchStore } from './src/services/deepResearch/researchStore.js';
import { ResearchJob } from './src/types/deepResearch.js';
import { UsageService } from './src/server/usageService.js';
import { BillingAdapterRegistry } from './src/services/billing/BillingAdapterRegistry.js';
