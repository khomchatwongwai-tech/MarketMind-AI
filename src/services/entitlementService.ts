...
export class EntitlementService {
  ...
  static getEntitlements(user: UserProfile | null | undefined): FeatureEntitlements {
    ...
    return {
      ...
      canUseConnectedPortfolio: planConfig.limits.canUseConnectedPortfolio ?? (effectivePlan !== 'free'),
      canUseRiskGuardian: planConfig.limits.canUseRiskGuardian ?? (effectivePlan === 'pro' || effectivePlan === 'premium'),
      maxConnectedAccounts: planConfig.limits.maxConnectedAccounts ?? 5,
